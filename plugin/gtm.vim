...
let s:no_gtm_err = 'GTM not found, install GTM or update your PATH'
let s:gtm_ver_err = 'GTM is out of date and may not work properly, please install the latest GTM executable'
let s:gtm_url = 'see https://github.com/DEVELOPEST/gtm-core'
